...
@Component({
  selector: 'app-landing-couch',
  templateUrl: './landing-couch.component.html',
  styleUrls: ['./landing-couch.component.css']
})
export class LandingCouchComponent implements OnInit {
